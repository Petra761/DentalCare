...
// Generate 30-min slots based on service duration
...
// ─── Appointment Form (used by both modals) ──────────────────────────────────────
...
const ApptForm: React.FC<ApptFormProps> = ({
    ...
    <form onSubmit={handleSubmit} style={{padding:'28px', display:'flex', flexDirection:'column', gap:20}}>
      ...
      <div style={{display:'flex', gap:16}}>
        ...
        <div style={{flex:1}}>
          ...
          {/* Contextual hints — only one shows at a time */}
          {!selectedClient && (
            <span style={{
